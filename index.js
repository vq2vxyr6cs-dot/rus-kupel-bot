...
bot.start(async (ctx) => {
  ...
  await ctx.replyWithPhoto(
    { url: 'https://example.com/ваше-фото-бани.jpg' }, // Замените на реальное фото
    {
...
bot.hears('🎥 Богатырская баня', async (ctx) => {
  await ctx.replyWithVideo(
    'https://www.youtube.com/watch?v=ССЫЛКА_НА_ВИДЕО_1', // Замените на реальную ссылку
    {
...
bot.hears('🎥 Царь баня', async (ctx) => {
  await ctx.replyWithVideo(
    'https://www.youtube.com/watch?v=ССЫЛКА_НА_ВИДЕО_2', // Замените на реальную ссылку
    {
...
bot.hears('💰 Цены', async (ctx) => {
  ...
  // await ctx.reply(
  //   '💰 *Актуальные цены:*\n\n' +
  //   '• Богатырская баня: 1500 руб/час\n' +
  //   '• Царь баня: 2000 руб/час\n' +
