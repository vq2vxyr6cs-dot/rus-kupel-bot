  ...
  await ctx.replyWithPhoto(
    { url: 'https://ltdfoto.ru/images/2025/12/08/PRAIS-01.10.2025.png' },
    {
      caption: '💰 *Актуальные цены на бани:*\n\n' +
               '• Богатырская баня: 1200 руб (1 час), 1500 руб (2 часа), 2000 руб (3+ часа)\n' +
...
app.listen(PORT, () => {
  ...
  console.log(`📡 Вебхук: https://rus-kupel-bot.onrender.com/webhook`);
  console.log(`🔗 Порт: ${PORT}`);
});

// Запускаем бота (вебхук уже установлен вручную)
bot.launch();
